...
namespace ogani_master.Areas.Admin.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Index(string? searchQuery, int? page)
        {
            ...
            searchQuery = string.IsNullOrEmpty(searchQuery) ? string.Empty : searchQuery.Trim();
            ...
            var pagedList = new StaticPagedList<Product>(products, pageNumber, pageSize, _context.Products.Count());
